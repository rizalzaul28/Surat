...
public class Bagian {
    ...
    private String kode_bagian, nama_bagian;
    ...
    public void KodeTambah() {
        query = "INSERT INTO bagian (id, kode_bagian, nama_bagian) VALUES (?,?,?)";
        try {
    ...
    public void KodeUbah() {
        query = "UPDATE bagian SET kode_bagian = ?, nama_bagian = ? WHERE id = ?";
